...
description: Recall-first TeamShared memory protocol 1.24.0 for Claude Code. Use on every turn when TeamShared MCP tools are available, and when searching or storing team memory, past work, preferences, playbooks, soul, or agent memory.
---
